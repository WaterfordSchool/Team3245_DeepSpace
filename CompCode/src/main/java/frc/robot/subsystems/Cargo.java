...
import frc.robot.commands.CargoWheels;
import frc.robot.commands.CargoWrist;
...
public class Cargo extends Subsystem {
  ...
  public void inSpin(double speed){
    wheelsMotor.set(speed);
  }
  public void outSpin(double speed){
    wheelsMotor.set(speed);
  }
  ...
  public void initDefaultCommand() {
    ...
    // setDefaultCommand(new MySpecialCommand());
      ...
      setDefaultCommand(new CargoWrist());
